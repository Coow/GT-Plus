...
using Logger = VmixGtPlus.Services.Logger;

namespace VmixGtPlus.Views;

public partial class AboutWindow : Window
{
    private const string RepoUrl = "https://github.com/Coow/vmix-gt-plus";
    ...
    private static string ReadVersion()
    {
        try
        {
            using var stream = AssetLoader.Open(new Uri("avares://VmixGtPlus/Assets/version.json"));
